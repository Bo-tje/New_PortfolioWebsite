    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
          ...
          description="First i start with doing research in order to figure out what is needed and how it has been done before"
          >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
            ...
            description="After having done some research, i can start protyping and developing a basic product"
            >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
            ...
            description="After having my work reviewed, its time to take a step back and improve the prototype"
            >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        group-hover/canvas-card:-translate-y-4 absolute
        top-[50%] left-[50%] translate-x-[-50%]
        translate-y-[-50%]
        group-hover/canvas-card:opacity-0 transition 
        duration-200 w-full  mx-auto flex items-center 
        justify-center">
          {icon}
        </div>
